/*
Program Description: Using binary search - This program allows the user to search for the earliest occurrence of an issue code for a given product id across all production lines.
...
struct QAlogs prod_1[amount], temp[amount*4], prod_2[amount],prod_3[amount], prod_4[amount], all_prod[(amount*4)], temp_search[1];
